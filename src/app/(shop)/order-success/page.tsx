  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-16 px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-bold" style={{ color: "var(--fg)" }}>Order Confirmed!</h1>
        <p className="mt-3 text-sm leading-relaxed" style={{ color: "var(--fg-muted)" }}>
          Thank you for your order. We&apos;ve received it and are processing it right now.
        </p>
        ...
        <div className="mt-4 glass-card rounded-2xl p-5">
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              ...
              {whatsappStatus === "sent" ? (
                <p className="text-xs text-emerald-400">Order details sent successfully</p>
              ) : (
