...
import { hasPermission, type AdminPermission } from "@/lib/security/permissions";
...
export default function AdminSidebar({ isOpen, onClose, role = "OWNER" }: AdminSidebarProps) {
